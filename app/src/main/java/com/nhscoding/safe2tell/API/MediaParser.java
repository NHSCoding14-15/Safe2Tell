 ...
 */
public class MediaParser extends AsyncTask<InputStream, InputStream, InputStream> {
    ...
    protected void onPostExecute(InputStream is) {
        ...
        Log.i("Media Parser", "Data Recieved");
        try {
    ...
    public MediaObject readSection(JsonReader reader) throws IOException {
        int id = -1;
        String name = "";
        reader.beginObject();
        while (reader.hasNext()) {
